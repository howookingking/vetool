...
type Props = {
  memo: TxMemo
  onDelete: () => void
  handleEditMemo: (editedMemo: TxMemo, memoIndex: number) => Promise<void>
  memoIndex: number
  isMemoNameSetting?: boolean
}

const SingleTxMemo = React.forwardRef<HTMLLIElement, Props>(
...
SingleTxMemo.displayName = 'SingleTxMemo'

export default SingleTxMemo
